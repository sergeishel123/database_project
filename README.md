...
8) Создали индекс по полю name таблицы Buyer для демонстарции различий скорости выполнения запросов выборки select, соединения таблиц Buyer и Car по условию Car.buyer_id = Buyer.id а также сортировки ORDER BY name таблицы Buyer
